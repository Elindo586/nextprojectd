export default async function stuff(req, res) {
  ...
  const mailData = {
    ...
    to: email,
    subject: `Seguimiento para ${firstName} ${lastName}  | ${company}`,
    text: ``,
    html: `<div> <div> Hola ${firstName},</div> <br/>
             <div> ¿Cómo va todo? </div>
             <div> Fue un gusto encontarnos en el show de Las Vegas hace un tiempo. </div><br/>
          ...
          <div> Saludos,</div> <br />
          <div> Edgar Lindo</div>
          <div> WhatsApp: <a href="https://wa.me/15866125270">+1-586-612-5270</a></div>
          <div> Email: <a href="mailto:info@tu.biz">info@tu.biz</a> </div>`,
  };
