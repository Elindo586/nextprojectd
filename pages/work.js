...
export default function Work({ db }) {
  ...
  return (
    <div className="main-about">
      ...
      <div className=" row row-2-index align-items-end test">
      ...
      <div className="row row-1-index">
        ...
        <p>
          ...
          If you are a purchasing agent, maintenance person, or engineer working
          in an industrial plant needing of some specific items, then maybe I
          would be able to find some alternative solutions for your needs
          depending on the products. If it is a product falling into
          distribution category I could let you know about our partner in your
          area, and if it is a product outside the distribution line then maybe
          I could find an alternative product.
        </p>
      </div>
      <div className="row row-2-index align-items-end">
        ...
        <p>
          If you are calling from outside the United States there is no problem
          on quoting products put in the United States, or location such as
          Miami or on the border to Mexico. We can also quote international
          transportation but if you have your own carrier that would be better
          if you can work with your own transportation company. <br /> <br />
